...
- **Teacher** — print reward coupons, track redemptions, teacher-related tools. When **Houses** is enabled for the school, teachers can pin **Houses** from Add more (school-wide rosters and standings; coordinate with one lead teacher).
