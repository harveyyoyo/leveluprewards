...
2. **Students** (`students`): Student roster management: add, edit, or remove students, nicknames, grade levels, student themes (custom colors and sticker emoji), face recognition enrollment, and printable ID cards.
