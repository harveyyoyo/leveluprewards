...
const TRACK_VIDEO = {
  ...
  chiptune: ['classroom-arcade', 'story-badge-unlocked', 'story-idcard-themes'],
  ...
  'playful-pizz': ['story-classroom-onetap', 'story-seating-shuffle'],
  ...
  'office-electro': ['office-rapid', 'story-staff-notifications', 'demo-howitworks'],
  'bus-groove': 'story-office-bus',
  'vending-bounce': 'story-rewards-vending',
  'firstweek-story': 'story-maya-firstweek',
  'lobby-lounge': ['story-lobby-tv', 'story-bulletin-board'],
