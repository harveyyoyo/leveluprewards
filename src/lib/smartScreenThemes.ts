...
export const SMART_SCREEN_THEME_PAGE_META: Record<SmartScreenTheme, SmartScreenThemePageMeta> = {
  ...
  midnight: { pageBg: '#0a0f1d', pageText: '#ffffff', colorScheme: 'dark' },
...
export const SMART_SCREEN_THEME_CLASSES: Record<SmartScreenTheme, SmartScreenThemeTokens> = {
  ...
  midnight: {
    page: 'bg-[#0a0f1d] text-white',
    panel: 'border-cyan-400/35 bg-slate-900/95 text-white shadow-xl shadow-cyan-950/40',
    quiet: 'text-slate-300 font-medium',
    accent: 'text-cyan-400 font-bold',
    badge: 'border-cyan-400/50 bg-cyan-950/80 text-cyan-200 font-semibold',
    rail: 'bg-cyan-400',
    watermark: 'border-cyan-400/25 bg-slate-900/80 text-cyan-100/90',
  },
  studio: {
