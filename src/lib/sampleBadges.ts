...
export const SAMPLE_BADGES: Omit<Achievement, 'id'>[] = [
  {
    name: 'Early Bird',
    description: 'Earn your first 50 all-time points.',
    icon: 'Sun',
    criteria: { type: 'lifetimePoints', threshold: 50 },
    bonusPoints: 5,
    tier: 'bronze',
    accentColor: '#b45309',
  },
  {
    name: 'Century',
    description: 'Reach 100 all-time points.',
    icon: 'Target',
    criteria: { type: 'lifetimePoints', threshold: 100 },
    bonusPoints: 10,
    tier: 'silver',
    accentColor: '#64748b',
  },
  {
    name: 'Rising Star',
    description: 'Reach 250 all-time points.',
    icon: 'Star',
    criteria: { type: 'lifetimePoints', threshold: 250 },
    bonusPoints: 15,
    tier: 'gold',
    accentColor: '#eab308',
  },
  {
    name: 'Half Grand',
    description: 'Earn 500 total all-time points.',
    icon: 'TrendingUp',
  ...
  {
    name: 'Star Student',
    description: 'Earn 1,000 total all-time points.',
    icon: 'Trophy',
  ...
  {
    name: 'Champion',
    description: 'Reach 2,500 total all-time points.',
    icon: 'Award',
    criteria: { type: 'lifetimePoints', threshold: 2500 },
    bonusPoints: 100,
    tier: 'platinum',
    accentColor: '#8b5cf6',
  },
