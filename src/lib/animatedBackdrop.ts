...
export const ANIMATED_BACKGROUND_STYLES = [
  ...
  { id: 'prize_booth', label: 'Prize booth', description: 'Tickets, gifts & coupon-redemption energy' },
  ...
  { id: 'diagonal_stripes', label: 'Diagonal stripes', description: 'Bold repeating bands — poster / ticket-stub energy' },
