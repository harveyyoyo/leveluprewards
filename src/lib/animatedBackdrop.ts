...
export const ANIMATED_BACKGROUND_STYLES = [
  ...
  { id: 'prize_burst', label: 'Reward burst', description: 'Bold reward colors & high-energy wash' },
  ...
  { id: 'prize_booth', label: 'Reward booth', description: 'Vouchers, gifts & coupon-redemption energy' },
  ...
  { id: 'reward_mega', label: 'Reward mega-mix', description: 'All app reward themes blended — points, rewards, fame, badges & attendance' },
