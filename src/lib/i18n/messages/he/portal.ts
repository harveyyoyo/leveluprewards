const portal = {
  ...
  studentHome: {
    title: 'פורטל בית תלמיד',
    description: 'תלמידים נכנסים מהבית לצפייה בנקודות, תגים, יעדים ודירוג בתים.',
  },
  parentPortal: {
    title: 'פורטל הורים',
  ...
  library: {
    title: 'ספרייה',
    description: 'חפשו ספרים, השאילו והחזירו, ותנו לתלמידים להשאיל בעצמם.',
  },
  libraryKiosk: {
    title: 'קיוסק ספרייה',
    description: 'עמדת השאלה והחזרת ספרים עצמאית לתלמידים עם סריקת תג והמלצות קריאה.',
  },
  roles: {
