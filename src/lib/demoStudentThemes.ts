...
/** Same palette permuted for the Yeshiva demo list so the two schools do not look identical row-for-row. */
const yeshivaPermutation = [4, 2, 7, 0, 5, 1, 3, 6];
export const DEMO_STUDENT_THEMES_YESHIVA_ORDER: StudentTheme[] = yeshivaPermutation.map(
  (i) => DEMO_STUDENT_THEMES[i],
);
