...
interface PrizeIdDTCPrintSheetProps {
  prizes: Prize[];
  schoolId: string | null;
  onReady: () => void;
}

export function PrizeIdDTCPrintSheet({ prizes, schoolId, onReady }: PrizeIdDTCPrintSheetProps) {
  ...
  const content = (
    <div id="prize-id-dtc-print-wrapper" aria-hidden>
      <style dangerouslySetInnerHTML={{__html: `
        #prize-id-dtc-print-wrapper {
          position: fixed;
          left: -10000px;
          top: 0;
          width: 85.6mm;
        ...
        @media print {
          ...
          body.dtc-card-printing > *:not(#prize-id-dtc-print-wrapper) {
          ...
          body.dtc-card-printing #prize-id-dtc-print-wrapper {
          ...
          body.dtc-card-printing #prize-id-dtc-print-wrapper .dtc-page {
            page-break-after: always !important;
            break-after: page !important;
          }
          body.dtc-card-printing #prize-id-dtc-print-wrapper .dtc-page:last-child {
      ...
      `}} />
      {prizes.map((p) => (
        <div key={p.id} className="dtc-page">
          <PrizeIdCard
            prize={p}
