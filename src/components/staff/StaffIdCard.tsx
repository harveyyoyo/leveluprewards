        ...
        <>
          <div className="credit-card-top">
            ...
            {useQr ? (
              ...
              <div
                className="print-id-avatar flex items-center justify-center text-lg font-black"
                style={avatarStyle}
                aria-hidden
              >
                {staffInitials}
          ...
          <div className="credit-card-mid" style={headerStyle}>
            ...
            <div className="credit-card-identity">
              <div className="print-id-text">
                <div className="print-id-name">{displayName}</div>
                <p className="print-id-nickname" style={{ color: mainMutedText }}>{roleLabel}</p>
              </div>
