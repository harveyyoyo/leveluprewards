...
function AuroraLayer() {
  return (
    <>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[560px] w-[560px] rounded-full bg-chart-3/12 blur-[130px] animate-arcade-aurora-blob pointer-events-none" style={{ animationDelay: '-12s' }} />
...
function ClassroomLayer() {
  return (
    <>
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-950/18 via-background to-slate-900/12 dark:from-emerald-950/28 dark:to-slate-950/20" />
      <div className="absolute -top-24 -left-16 h-[min(420px,48vh)] w-[min(420px,48vh)] rounded-full bg-emerald-800/12 blur-[100px] animate-arcade-aurora-blob-slow pointer-events-none" />
...
function CampusLayer() {
  return (
    <>
      <div className="absolute -top-32 left-[5%] h-[min(500px,55vh)] w-[min(500px,90vw)] rounded-full bg-sky-400/22 blur-[115px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute top-[35%] -right-[10%] h-[min(440px,48vh)] w-[min(440px,80vw)] rounded-full bg-blue-300/16 blur-[105px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute -bottom-20 left-[25%] h-[min(360px,40vh)] w-[min(700px,95vw)] rounded-full bg-white/25 blur-[90px] animate-arcade-aurora-blob-fast pointer-events-none dark:bg-sky-100/12" />
      <div className="absolute inset-0 bg-gradient-to-b from-sky-500/8 via-transparent to-background/55 dark:from-sky-400/10 dark:to-background/75" />
...
function StudyHallLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-br from-amber-950/10 via-background to-stone-800/10 dark:from-amber-950/18 dark:to-stone-950/18" />
      <div className="absolute -top-20 right-[8%] h-[min(460px,50vh)] w-[min(460px,75vw)] rounded-full bg-amber-200/18 blur-[100px] animate-arcade-aurora-blob pointer-events-none dark:bg-amber-500/14" />
      <div className="absolute bottom-0 left-0 h-[min(400px,45vh)] w-[min(520px,85vw)] rounded-full bg-orange-900/10 blur-[95px] animate-arcade-aurora-blob-slow pointer-events-none dark:bg-orange-950/22" />
      <div className="absolute top-1/2 left-1/3 h-[min(320px,38vh)] w-[min(320px,50vw)] rounded-full bg-stone-400/12 blur-[85px] animate-arcade-aurora-blob-fast pointer-events-none dark:bg-stone-600/15" />
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-background/55 via-amber-950/5 to-background/40 dark:from-background/72 dark:to-background/50" />
    </>
  );
}
...
function CelebrationLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-br from-chart-1/8 via-chart-5/6 to-chart-3/8" />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-background/25 via-transparent to-background/60 dark:to-background/78" />
    </>
  );
}
...
function TrophyGlowLayer() {
  return (
    <>
      <div className="absolute -top-16 left-[12%] h-[min(480px,52vh)] w-[min(480px,52vh)] rounded-full bg-amber-400/28 blur-[105px] animate-arcade-aurora-blob-fast pointer-events-none" />
      ...
      <div className="absolute top-[38%] left-1/2 h-[min(380px,42vh)] w-[min(380px,70vw)] -translate-x-1/2 rounded-full bg-chart-4/22 blur-[95px] animate-arcade-aurora-blob-slow pointer-events-none" />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-amber-500/6 via-transparent to-background/65 dark:from-amber-400/8 dark:to-background/82" />
    </>
  );
}
...
function ScienceLabLayer() {
  return (
    <>
      ...
      <div className="absolute top-[30%] -right-[12%] h-[min(400px,46vh)] w-[min(400px,46vh)] rounded-full bg-cyan-400/18 blur-[100px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute -bottom-16 left-[20%] h-[min(360px,42vh)] w-[min(560px,90vw)] rounded-full bg-sky-500/14 blur-[95px] animate-arcade-aurora-blob-fast pointer-events-none" />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-teal-950/8 via-transparent to-background/68 dark:from-teal-950/14 dark:to-background/82" />
    </>
  );
}
...
function ArtStudioLayer() {
  return (
    <>
      <div className="absolute -top-20 -left-12 h-[min(380px,44vh)] w-[min(380px,44vh)] rounded-full bg-chart-1/22 blur-[95px] animate-arcade-aurora-blob-fast pointer-events-none" />
      ...
      <div className="absolute bottom-0 left-[10%] h-[min(400px,45vh)] w-[min(640px,92vw)] rounded-full bg-chart-3/18 blur-[110px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 h-[min(340px,40vh)] w-[min(340px,55vw)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-chart-2/14 blur-[90px] animate-arcade-aurora-blob-fast pointer-events-none" style={{ animationDelay: '-5s' }} />
      <div className="absolute inset-0 opacity-[0.28]">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-chart-4/6 via-transparent to-chart-2/8" />
...
function FieldDayLayer() {
  return (
    <>
      <div className="absolute -top-24 left-[6%] h-[min(480px,52vh)] w-[min(480px,52vh)] rounded-full bg-lime-400/18 blur-[105px] animate-arcade-aurora-blob pointer-events-none" />
      ...
      <div className="absolute -bottom-12 left-[28%] h-[min(380px,42vh)] w-[min(680px,94vw)] rounded-full bg-emerald-400/14 blur-[95px] animate-arcade-aurora-blob-fast pointer-events-none" />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-lime-500/6 via-transparent to-background/62 dark:to-background/78" />
    </>
  );
}
...
function MidnightStudyLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-b from-indigo-950/25 via-violet-950/12 to-background dark:from-indigo-950/35 dark:via-violet-950/18" />
      <div className="absolute -top-32 left-[10%] h-[min(460px,50vh)] w-[min(460px,50vh)] rounded-full bg-indigo-600/18 blur-[110px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute bottom-0 right-0 h-[min(400px,44vh)] w-[min(400px,44vh)] rounded-full bg-violet-700/16 blur-[100px] animate-arcade-aurora-blob pointer-events-none" />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-background/25 via-transparent to-background/75 dark:to-background/88" />
    </>
  );
}
...
function OceanBreezeLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-b from-sky-600/8 via-teal-600/6 to-background dark:from-sky-500/10 dark:via-teal-700/8" />
      <div className="absolute top-[15%] -left-[15%] h-[min(380px,42vh)] w-[min(90vw,820px)] rounded-full bg-cyan-500/14 blur-[100px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute top-[45%] -right-[10%] h-[min(360px,40vh)] w-[min(85vw,760px)] rounded-full bg-blue-500/16 blur-[95px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute -bottom-24 left-[5%] h-[min(340px,38vh)] w-[min(95vw,880px)] rounded-full bg-teal-600/12 blur-[105px] animate-arcade-aurora-blob-fast pointer-events-none" />
      <div className="absolute inset-0 opacity-[0.22]">
...
function CandyRushLayer() {
  return (
    <>
      <div className="absolute -top-20 right-[6%] h-[min(460px,50vh)] w-[min(460px,50vh)] rounded-full bg-pink-400/22 blur-[100px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute top-[32%] -left-[8%] h-[min(400px,44vh)] w-[min(400px,44vh)] rounded-full bg-rose-400/18 blur-[98px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute bottom-0 left-[18%] h-[min(420px,46vh)] w-[min(680px,92vw)] rounded-full bg-emerald-300/14 blur-[105px] animate-arcade-aurora-blob-fast pointer-events-none dark:bg-emerald-500/12" />
      <div className="absolute top-1/2 right-[15%] h-[min(280px,32vh)] w-[min(280px,32vh)] rounded-full bg-violet-400/12 blur-[85px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute inset-0 opacity-[0.3]">
...
function RainbowPopLayer() {
  return (
    <>
      <div className="absolute -top-28 left-1/2 h-[min(520px,55vh)] w-[min(95vw,900px)] -translate-x-1/2 rounded-full bg-gradient-to-r from-chart-1/20 via-chart-3/18 to-chart-5/20 blur-[120px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute bottom-0 left-0 h-[min(400px,45vh)] w-[min(80vw,720px)] rounded-full bg-chart-2/16 blur-[105px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute top-[35%] -right-[5%] h-[min(360px,40vh)] w-[min(360px,40vh)] rounded-full bg-chart-4/18 blur-[95px] animate-arcade-aurora-blob-fast pointer-events-none" />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-chart-5/5 via-transparent to-background/68 dark:to-background/82" />
    </>
  );
}
...
function PointsBankLayer() {
  return (
    <>
      <div className="absolute -top-20 left-[8%] h-[min(460px,50vh)] w-[min(460px,50vh)] rounded-full bg-amber-400/26 blur-[105px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute top-[30%] -right-[10%] h-[min(420px,46vh)] w-[min(420px,46vh)] rounded-full bg-yellow-500/16 blur-[100px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute -bottom-16 left-[22%] h-[min(400px,44vh)] w-[min(700px,92vw)] rounded-full bg-chart-4/22 blur-[110px] animate-arcade-aurora-blob-fast pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 h-[min(300px,35vh)] w-[min(300px,35vh)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-orange-400/12 blur-[80px] animate-arcade-aurora-blob-slow pointer-events-none" style={{ animationDelay: '-10s' }} />
      <div className="absolute inset-0 opacity-[0.32]">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-amber-500/8 via-transparent to-background/66 dark:from-amber-400/10 dark:to-background/80" />
    </>
  );
}
...
function PrizeBoothLayer() {
  return (
    <>
      ...
      <div className="absolute top-[25%] -left-[8%] h-[min(400px,44vh)] w-[min(400px,44vh)] rounded-full bg-red-500/14 blur-[95px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute bottom-0 left-[12%] h-[min(420px,46vh)] w-[min(680px,90vw)] rounded-full bg-chart-5/18 blur-[108px] animate-arcade-aurora-blob-fast pointer-events-none" />
      <div className="absolute top-[48%] right-[18%] h-[min(320px,36vh)] w-[min(320px,36vh)] rounded-full bg-amber-500/14 blur-[88px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute inset-0 opacity-[0.3]">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-rose-500/6 via-transparent to-chart-5/8" />
      <div className="absolute inset-0 bg-gradient-to-b from-background/22 via-transparent to-background/68 dark:to-background/82" />
    </>
  );
}
...
function HallOfFameLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-b from-violet-950/12 via-transparent to-amber-950/8 dark:from-violet-950/20 dark:to-amber-950/12" />
      <div className="absolute -top-28 left-1/2 h-[min(500px,54vh)] w-[min(92vw,880px)] -translate-x-1/2 rounded-full bg-violet-600/22 blur-[115px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute bottom-0 right-0 h-[min(440px,48vh)] w-[min(440px,48vh)] rounded-full bg-amber-500/18 blur-[102px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute top-[40%] -left-[12%] h-[min(380px,42vh)] w-[min(380px,42vh)] rounded-full bg-purple-700/14 blur-[95px] animate-arcade-aurora-blob-fast pointer-events-none" />
      <div className="absolute inset-0 opacity-[0.3]">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-background/20 via-transparent to-background/72 dark:to-background/86" />
    </>
  );
}
...
function BadgeWallLayer() {
  return (
    <>
      <div className="absolute -top-20 -left-10 h-[min(400px,46vh)] w-[min(400px,46vh)] rounded-full bg-chart-1/18 blur-[98px] animate-arcade-aurora-blob-fast pointer-events-none" />
      <div className="absolute top-[22%] right-0 h-[min(430px,48vh)] w-[min(430px,48vh)] rounded-full bg-chart-2/16 blur-[100px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute bottom-8 left-[15%] h-[min(380px,42vh)] w-[min(620px,88vw)] rounded-full bg-chart-3/16 blur-[105px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute top-1/2 right-[25%] h-[min(300px,34vh)] w-[min(300px,34vh)] rounded-full bg-chart-5/14 blur-[88px] animate-arcade-aurora-blob-fast pointer-events-none" style={{ animationDelay: '-7s' }} />
      <div className="absolute inset-0 opacity-[0.3]">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-chart-1/5 via-chart-3/6 to-chart-5/6" />
      <div className="absolute inset-0 bg-gradient-to-b from-background/18 via-transparent to-background/65 dark:to-background/80" />
    </>
  );
}
...
function RewardMegaLayer() {
  return (
    <>
      <div className="absolute -top-16 left-[4%] h-[min(360px,40vh)] w-[min(360px,40vh)] rounded-full bg-amber-400/14 blur-[92px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute top-[22%] -right-[6%] h-[min(340px,38vh)] w-[min(340px,38vh)] rounded-full bg-rose-500/12 blur-[88px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute top-[8%] left-[35%] h-[min(300px,34vh)] w-[min(300px,34vh)] rounded-full bg-violet-600/13 blur-[85px] animate-arcade-aurora-blob-fast pointer-events-none" />
      <div className="absolute bottom-[6%] left-[8%] h-[min(380px,42vh)] w-[min(680px,88vw)] rounded-full bg-emerald-500/11 blur-[98px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute top-[48%] left-[12%] h-[min(260px,30vh)] w-[min(260px,30vh)] rounded-full bg-chart-1/11 blur-[78px] animate-arcade-aurora-blob-slow pointer-events-none" style={{ animationDelay: '-9s' }} />
      <div className="absolute bottom-[18%] right-[8%] h-[min(320px,36vh)] w-[min(320px,36vh)] rounded-full bg-chart-3/12 blur-[90px] animate-arcade-aurora-blob-fast pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 h-[min(420px,48vmin)] w-[min(420px,48vmin)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-chart-5/9 blur-[105px] animate-arcade-aurora-blob pointer-events-none" style={{ animationDelay: '-15s' }} />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-background/15 via-transparent to-background/70 dark:to-background/82" />
    </>
  );
}
...
function SunriseRaysLayer() {
  return (
    <>
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-background/75 via-background/15 to-background/40 dark:from-background/88 dark:to-background/50" />
    </>
  );
}
...
const BOKEH: { top: string; left: string; size: number; cls: string; delay: string; blur: string }[] = [
  ...
  { top: '22%', left: '38%', size: 56, cls: 'bg-amber-300/38', delay: '1.1s', blur: 'blur-2xl' },
  { top: '18%', left: '88%', size: 28, cls: 'bg-violet-400/35', delay: '0.3s', blur: 'blur-lg' },
  { top: '38%', left: '4%', size: 40, cls: 'bg-emerald-400/32', delay: '1.8s', blur: 'blur-xl' },
  { top: '42%', left: '58%', size: 52, cls: 'bg-chart-2/40', delay: '0.5s', blur: 'blur-2xl' },
  { top: '48%', left: '28%', size: 32, cls: 'bg-chart-5/38', delay: '2.1s', blur: 'blur-lg' },
  { top: '52%', left: '82%', size: 44, cls: 'bg-cyan-300/35', delay: '0.9s', blur: 'blur-xl' },
  { top: '62%', left: '14%', size: 38, cls: 'bg-chart-1/36', delay: '1.4s', blur: 'blur-xl' },
  ...
  { top: '8%', left: '52%', size: 30, cls: 'bg-blue-400/32', delay: '2.3s', blur: 'blur-lg' },
  { top: '28%', left: '92%', size: 42, cls: 'bg-chart-3/38', delay: '0.6s', blur: 'blur-xl' },
  { top: '58%', left: '92%', size: 36, cls: 'bg-orange-300/34', delay: '1.9s', blur: 'blur-xl' },
  { top: '78%', left: '32%', size: 50, cls: 'bg-teal-400/32', delay: '0.4s', blur: 'blur-2xl' },
  { top: '84%', left: '8%', size: 34, cls: 'bg-pink-300/33', delay: '2s', blur: 'blur-lg' },
  ...
  { top: '64%', left: '68%', size: 28, cls: 'bg-chart-4/36', delay: '0.8s', blur: 'blur-lg' },
];

function BokehFieldLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-b from-slate-500/6 via-transparent to-violet-500/8 dark:from-slate-400/8 dark:to-violet-950/15" />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-background/25 via-transparent to-background/72 dark:to-background/86" />
    </>
  );
}
...
function ContourLinesLayer() {
  return (
    <>
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-chart-3/8 via-transparent to-chart-5/10 opacity-60 dark:opacity-70" />
...
function NeonArcadeLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/28 via-fuchsia-600/22 to-violet-600/26 dark:from-cyan-400/32 dark:via-fuchsia-500/28 dark:to-violet-500/30" />
      <div className="absolute -top-32 -left-20 h-[min(560px,60vh)] w-[min(560px,60vh)] rounded-full bg-cyan-400/48 blur-[100px] animate-arcade-bold-blob-fast pointer-events-none" />
      ...
      <div className="absolute bottom-[-8%] left-[15%] h-[min(480px,52vh)] w-[min(780px,96vw)] rounded-full bg-violet-500/42 blur-[120px] animate-arcade-bold-blob-slow pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 h-[min(440px,50vmin)] w-[min(440px,50vmin)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-chart-3/38 blur-[110px] animate-arcade-bold-blob-fast pointer-events-none" style={{ animationDelay: '-4s' }} />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-background/18 via-transparent to-background/48 dark:from-background/22 dark:to-background/58" />
    </>
  );
}
...
function HyperwaveLayer() {
  return (
    <>
      ...
      />
      <div className="absolute -top-28 left-[4%] h-[min(540px,58vh)] w-[min(540px,58vh)] rounded-full bg-chart-1/44 blur-[118px] animate-arcade-bold-blob pointer-events-none" />
      ...
      <div className="absolute -bottom-20 left-[20%] h-[min(460px,50vh)] w-[min(820px,98vw)] rounded-full bg-chart-2/38 blur-[125px] animate-arcade-bold-blob-fast pointer-events-none" />
      <div className="absolute inset-0 opacity-[0.5]">
...
function SolarFlareLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-b from-amber-400/22 via-orange-500/18 to-red-600/20 dark:from-amber-500/26 dark:via-orange-600/22 dark:to-red-700/24" />
      ...
      <div className="absolute bottom-[-10%] right-[4%] h-[min(480px,52vh)] w-[min(480px,52vh)] rounded-full bg-red-500/42 blur-[105px] animate-arcade-bold-blob pointer-events-none" />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-background/25 via-transparent to-background/52 dark:to-background/62" />
    </>
  );
}
...
function ChromaSpinLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-br from-chart-1/20 via-chart-3/18 to-chart-5/22" />
      ...
      <div className="absolute -top-20 right-[6%] h-[min(500px,54vh)] w-[min(500px,54vh)] rounded-full bg-chart-2/46 blur-[115px] animate-arcade-bold-blob pointer-events-none" />
      <div className="absolute bottom-[5%] left-[6%] h-[min(460px,50vh)] w-[min(460px,50vh)] rounded-full bg-chart-4/42 blur-[108px] animate-arcade-bold-blob-slow pointer-events-none" />
      <div className="absolute top-[36%] -left-[8%] h-[min(400px,44vh)] w-[min(400px,44vh)] rounded-full bg-chart-1/44 blur-[102px] animate-arcade-bold-blob-fast pointer-events-none" />
      <div className="absolute inset-0 opacity-[0.55]">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-background/40 via-background/12 to-background/55 dark:from-background/48 dark:via-background/15 dark:to-background/65" />
    </>
  );
}
...
function SillyStringLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-br from-fuchsia-500/14 via-yellow-400/10 to-cyan-500/14 dark:from-fuchsia-400/18 dark:via-amber-300/12 dark:to-sky-400/16" />
      <div
      ...
      />
      <div className="absolute -top-16 right-[10%] h-[min(480px,50vh)] w-[min(480px,50vh)] rounded-full bg-fuchsia-400/28 blur-[108px] animate-arcade-bold-blob-fast pointer-events-none" />
      <div className="absolute bottom-[6%] left-[8%] h-[min(420px,46vh)] w-[min(420px,46vh)] rounded-full bg-cyan-400/22 blur-[102px] animate-arcade-bold-blob-slow pointer-events-none" />
      <div className="absolute inset-0 opacity-[0.55]">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-background/38 via-background/8 to-background/58 dark:from-background/44 dark:via-background/10 dark:to-background/68" />
    </>
  );
}
...
function GlitterGoblinLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-br from-violet-950/20 via-emerald-950/12 to-fuchsia-950/16 dark:from-violet-900/24 dark:via-emerald-950/18 dark:to-fuchsia-950/20" />
      <div className="absolute -top-20 left-[6%] h-[min(500px,54vh)] w-[min(500px,54vh)] rounded-full bg-violet-500/26 blur-[112px] animate-arcade-bold-blob pointer-events-none" />
      <div className="absolute top-[32%] -right-[8%] h-[min(440px,48vh)] w-[min(440px,48vh)] rounded-full bg-emerald-400/22 blur-[105px] animate-arcade-bold-blob-fast pointer-events-none" />
      <div className="absolute bottom-[-5%] left-[28%] h-[min(400px,44vh)] w-[min(640px,90vw)] rounded-full bg-fuchsia-500/18 blur-[98px] animate-arcade-bold-blob-slow pointer-events-none" />
      <div className="absolute inset-0 opacity-[0.5]">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-background/42 via-background/10 to-background/62 dark:from-background/48 dark:via-background/12 dark:to-background/72" />
    </>
  );
}
...
function DiscoDetentionLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-b from-indigo-950/18 via-fuchsia-950/14 to-orange-950/16 dark:from-indigo-950/22 dark:via-purple-950/18 dark:to-orange-950/20" />
      ...
      <div className="absolute bottom-[12%] right-[10%] h-[min(360px,38vh)] w-[min(360px,38vh)] rounded-full bg-orange-400/22 blur-[92px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute inset-0 opacity-[0.48]">
        ...
        <Music2 className="absolute bottom-[22%] right-[26%] w-10 h-10 text-orange-500/78 dark:text-orange-300/72 animate-float" style={{ animationDelay: '1.1s' }} />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-background/45 via-background/12 to-background/60 dark:from-background/52 dark:via-background/14 dark:to-background/70" />
    </>
  );
}
...
function SnackEmergencyLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-br from-amber-100/25 via-orange-200/15 to-rose-200/18 dark:from-amber-950/20 dark:via-orange-950/16 dark:to-rose-950/18" />
      <div className="absolute -top-24 right-[8%] h-[min(460px,48vh)] w-[min(460px,48vh)] rounded-full bg-orange-300/30 blur-[104px] animate-arcade-bold-blob pointer-events-none dark:bg-orange-500/22" />
      <div className="absolute bottom-0 left-[4%] h-[min(420px,45vh)] w-[min(520px,85vw)] rounded-full bg-amber-200/28 blur-[100px] animate-arcade-bold-blob-slow pointer-events-none dark:bg-amber-600/18" />
      <div className="absolute top-[40%] -left-[6%] h-[min(340px,36vh)] w-[min(340px,36vh)] rounded-full bg-rose-300/22 blur-[88px] animate-arcade-bold-blob-fast pointer-events-none dark:bg-rose-500/16" />
      <div className="absolute inset-0 opacity-[0.52]">
        ...
        <Cookie className="absolute bottom-[26%] right-[14%] w-10 h-10 text-orange-600/68 dark:text-orange-400/62 animate-float" style={{ animationDelay: '0.4s' }} />
        <Candy className="absolute bottom-[14%] left-[24%] w-9 h-9 text-pink-500/72 dark:text-pink-400/65 animate-float" style={{ animationDelay: '1.2s' }} />
      </div>
      <div className="absolute inset-0 bg-gradient-to-b from-background/36 via-background/6 to-background/56 dark:from-background/44 dark:via-background/8 dark:to-background/66" />
    </>
  );
}
...
function AttendanceStreakLayer() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-950/10 via-background to-green-950/8 dark:from-emerald-950/18 dark:to-green-950/14" />
      <div className="absolute -top-24 left-[10%] h-[min(440px,48vh)] w-[min(440px,48vh)] rounded-full bg-emerald-500/18 blur-[102px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute top-[35%] -right-[10%] h-[min(400px,44vh)] w-[min(400px,44vh)] rounded-full bg-green-400/14 blur-[96px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute -bottom-12 left-[24%] h-[min(360px,40vh)] w-[min(680px,92vw)] rounded-full bg-teal-500/12 blur-[100px] animate-arcade-aurora-blob-fast pointer-events-none" />
      <div className="absolute inset-0 opacity-[0.28]">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-emerald-500/6 via-transparent to-background/66 dark:to-background/80" />
    </>
  );
}
...
function PrizeBurstLayer() {
  return (
    <>
      <div className="absolute -top-36 -left-24 h-[min(520px,58vh)] w-[min(520px,58vh)] rounded-full bg-chart-1/32 blur-[115px] animate-arcade-aurora-blob-fast pointer-events-none" />
      <div className="absolute top-[15%] -right-20 h-[min(500px,52vh)] w-[min(500px,52vh)] rounded-full bg-chart-5/28 blur-[110px] animate-arcade-aurora-blob pointer-events-none" />
      <div className="absolute bottom-0 left-[15%] h-[min(440px,48vh)] w-[min(720px,92vw)] rounded-full bg-chart-3/26 blur-[120px] animate-arcade-aurora-blob-slow pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 h-[min(600px,65vmin)] w-[min(600px,65vmin)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/22 blur-[125px] animate-arcade-aurora-blob-fast pointer-events-none" style={{ animationDelay: '-6s' }} />
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-background/20 to-background/72 dark:via-background/30 dark:to-background/88" />
    </>
  );
}
