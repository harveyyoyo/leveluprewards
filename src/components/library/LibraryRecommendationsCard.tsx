          ...
          {recommendations.map((rec) => (
            ...
            >
              <div className="space-y-1">
                ...
                <h4 className="line-clamp-2 text-xs font-bold text-foreground leading-snug pt-1" title={rec.name}>
                  {rec.name}
                </h4>
                <p className="line-clamp-1 text-[11px] text-muted-foreground" title={rec.author}>
                  {rec.author}
                </p>
              </div>
