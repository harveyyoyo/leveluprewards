...
const GUIDE_SECTIONS: GuideItem[] = [
  ...
  },
  {
    icon: Users,
    title: 'Roster',
    body: 'Add teachers first, assign each student on Students, group by class on Classes, or import a spreadsheet. Smart import in Settings can read messy files and work out classes, students, teachers, grades, and billing together.',
  },
  {
    icon: GraduationCap,
    title: 'Grades & terms',
