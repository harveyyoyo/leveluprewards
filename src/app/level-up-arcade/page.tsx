...
export const metadata = {
  title: 'Arcade landing — levelUp EDU',
  description:
    'PBIS arcade-style marketing landing (LevelUp Arcade variant).',
};

export default function LevelUpArcadeLandingPage() {
  return (
        ...
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-4 px-6 text-center">
          ...
          <div className="flex w-full flex-col items-center justify-between gap-4 text-xs text-slate-500 sm:flex-row sm:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 font-semibold sm:justify-end">
              <Link href={MARKETING_FLYERS_HREF} className="transition-colors hover:text-slate-300">
                Flyers
              </Link>
