...
export default function LibraryKioskPage() {
    ...
    return (
      <div className="min-h-[100dvh] flex flex-col items-center justify-center gap-4 p-6 max-w-md mx-auto text-center">
        <p className="text-muted-foreground">
          Student library self-checkout kiosk is turned off. Enable{' '}
          <strong className="text-foreground">Library station (shared device)</strong> under Library → Settings.
        </p>
        <Button variant="outline" className="rounded-xl" asChild>
          <Link href={`/${schoolId}/portal`}>Back to portal</Link>
        </Button>
