...
function LeftoverRealmHome({ children }: { children: React.ReactNode }) {
  return (
    <div data-classroom-home={classroomRealmHomeUi()}>
      {children}
    </div>
  );
}

/** Standalone Classroom page — leftover realm hub only. Do not remount the seating-chart command center. */
